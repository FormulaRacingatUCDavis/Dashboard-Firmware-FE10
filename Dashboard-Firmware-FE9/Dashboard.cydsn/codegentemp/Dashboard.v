...
module CAN_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("5ed46c91-7c5b-4a5a-9846-3a328252ba87/7f2e0196-39e5-4161-97bb-5d609ca138cf"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(1),
		  .period("0"),
		  .is_direct(0),
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_50_0 ADC_GLV_V (
        .aclk(1'b0),
        .eoc(Net_268),
        .sdone(Net_269),
        .soc(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a4f202a9-0a0e-4c90-8520-19263adeff40"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8c0c20fd-8585-4f33-a8df-6a0fc0eb292e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("55720c69-c88a-4f7e-88b8-795f61332225"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0f65f06f-aa4a-4beb-99fe-24c261cf01c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8e4f2b05-bd25-4d02-b625-e8976f16d981"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4828efa8-6f15-4921-9d02-173437c530ec"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RX_CAN1_net;
	wire [0:0] tmpIO_0__RX_CAN1_net;
	wire [0:0] tmpINTERRUPT_0__RX_CAN1_net;
	electrical [0:0] tmpSIOVREF__RX_CAN1_net;

	cy_psoc3_pins_v1_10
		#(.id("9a60e41d-e05b-409c-9f4f-631362a7f45f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RX_CAN1
		 (.oe(tmpOE__RX_CAN1_net),
		  .y({1'b0}),
		  .fb({Net_4}),
		  .io({tmpIO_0__RX_CAN1_net[0:0]}),
		  .siovref(tmpSIOVREF__RX_CAN1_net),
		  .interrupt({tmpINTERRUPT_0__RX_CAN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RX_CAN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX_CAN1_net;
	wire [0:0] tmpFB_0__TX_CAN1_net;
	wire [0:0] tmpIO_0__TX_CAN1_net;
	wire [0:0] tmpINTERRUPT_0__TX_CAN1_net;
	electrical [0:0] tmpSIOVREF__TX_CAN1_net;

	cy_psoc3_pins_v1_10
		#(.id("e9d1fd15-21ed-4071-b7a5-6755573130c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TX_CAN1
		 (.oe(tmpOE__TX_CAN1_net),
		  .y({Net_5}),
		  .fb({tmpFB_0__TX_CAN1_net[0:0]}),
		  .io({tmpIO_0__TX_CAN1_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_CAN1_net),
		  .interrupt({tmpINTERRUPT_0__TX_CAN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX_CAN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8404b4a3-d39f-46c1-909a-7ea9be012ff5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("97384ca9-95c0-41df-82dc-9d78dcd6fded"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("02150ba5-aa63-4d05-9263-07888a07a679"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [7:0] tmpOE__D_LSB_net;
	wire [7:0] tmpIO_7__D_LSB_net;
	wire [0:0] tmpINTERRUPT_0__D_LSB_net;
	electrical [0:0] tmpSIOVREF__D_LSB_net;
	...
	cy_psoc3_pins_v1_10
		...
		D_LSB
		 (.oe(tmpOE__D_LSB_net),
		  .y({Net_31[7:0]}),
		  .fb({Net_109[7:0]}),
		  .io({tmpIO_7__D_LSB_net[7:0]}),
		  .siovref(tmpSIOVREF__D_LSB_net),
		  .interrupt({tmpINTERRUPT_0__D_LSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D_LSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_39, Net_39, Net_39, Net_39, Net_39, Net_39, Net_39, Net_39} : {Net_39, Net_39, Net_39, Net_39, Net_39, Net_39, Net_39, Net_39};
	...
	cy_clock_v1_0
		#(.id("6a1c6f2d-b489-4aa9-916d-4346106ac9ef"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Timer_v2_80_4 ReadyToDrive_Timer (
        .capture(1'b0),
        .capture_out(Net_1261),
        .clock(Net_899),
        .enable(1'b1),
        .interrupt(Net_1263),
        .reset(Net_1264),
    ...
    defparam ReadyToDrive_Timer.Resolution = 16;
